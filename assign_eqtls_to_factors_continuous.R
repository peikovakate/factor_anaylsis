...
variants_metadata_file = "../data/sumstat_cs_variants/variants_metadata.tsv"
factors_tbl_output =  "../data/credible_sets/factor_cont_binary.tsv"
...
stand_betas = reshape2::melt(stand_betas, id="eqtl_id", variable.name = "factor", value.name="stand_beta")
############################################################
