...
output_library = "../data/mfactorization/unique_genes/"
...
write_tsv(effects, paste0(output_library, "effects.tsv"))
write_tsv(betas,  paste0(output_library, "betas.txt"))
write_tsv(pvalues, paste0(output_library, "pvalues.txt"))
write_tsv(ses,  paste0(output_library, "ses.txt"))
write_lines(colnames(betas), paste0(output_library, "tissues.txt"))
